#
#  Be sure to run `pod spec lint AlertToast.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "Elai Zuberman" => "email@address.com" }
  # Or just: spec.author    = "Elai Zuberman"
  # spec.authors            = { "Elai Zuberman" => "email@address.com" }
  # spec.social_media_url   = "https://twitter.com/Elai Zuberman"
